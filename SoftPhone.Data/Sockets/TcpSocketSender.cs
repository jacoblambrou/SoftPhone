        ...
        public class AsynchronousClient
        {
            ...
            public static void StartClient()
            {
                ...
                try
                {
                    ...
                    var ipAddress = IPAddress.Parse(Server.Address);
                    ...
                    StatusUpdated.Invoke($"Response received: {response}");
                ...
                {
                    StatusUpdated.Invoke(e.ToString());
                }
            }
            ...
            private static void ConnectCallback(IAsyncResult ar)
            {
                try
                {
                    ...
                    StatusUpdated.Invoke($"Socket connected to {client.RemoteEndPoint.ToString()}");
            ...
            private static void SendCallback(IAsyncResult ar)
            {
                try
                {
                    ...
                    StatusUpdated.Invoke($"Sent {bytesSent} bytes to server.");
